...
void stacker::imageChoice(string fName,int imgQty){
  ...
  if((fName != "orion" && fName != "cone_nebula" && fName != "n44f" && fName != "wfc3_uvis") || (imgQty < 10 || imgQty > 1)){
    cout << "Try again! This time with a valid file Name or valid amount of images" << endl;
    return;
  }
  else{
